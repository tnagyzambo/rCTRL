...
: ${AMENT_CURRENT_PREFIX:="/media/psf/CODE/ros-test/install/test_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_pkg/environment/path.sh"
