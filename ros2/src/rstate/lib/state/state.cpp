...
namespace rstate {
    ...
    rstate::msg::NetworkTransitionDescription generateNetworkTransitionDescription(NetworkTransitionEnum transition,
                                                                                   NetworkStateEnum start_state,
                                                                                   NetworkStateEnum goal_state) {
        rstate::msg::NetworkTransitionDescription transitionDescription;
